...
1. Added an AssetsManager class which will eventually store all graphics and sounds.
...
The project is starting to grow unmanagable as it grows. */
...
window.addEventListener("load", function(event) {
    ...
    the game. Because it only has to load the tilesheet image right now, it's ver specific
    about what it does. */
    ...
    AssetsManager.prototype = {
      ...
      /* The render function uses the new display methods now. Will eventuall have to create 
    ...
    /* Now image is loaded into the assets manager instead of the display.
