/* Moved the world object into its own class and made the Player class a class
inside of Game.World. This was done to compartmentalize the objects more
...
Game.World = function(friction = 0.9, gravity = 3) {
    ...
    /* Here is the map data. Later on it will load from a json file, but for now
    it will just be hardcoded here. */
...
/* Now that the world is a class, the more generic functions will be moved into its prototype. */
...
/* The player is also its own class now. Since player only appears in the
context of Game.World, that is where it is defined. */
