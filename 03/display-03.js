/* Moved some generic functions to the Display.prototype.
Created the Display.TileSheet class, which handles the tilesheet image and its dimensions.
Got rid of the drawRectangle function and replaced it with the drawPlayer function. */
