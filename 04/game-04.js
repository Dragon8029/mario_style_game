/* In part 4, collision detection and response has been added for the tile map. Also
fixed the tile map offset from part 3, where every graphical value was offset by 1 due to the export format of the tile map editor used. 
Add the collision_map and the collider object to hadnle collision. Also add a sperclass called Object
...
Game.World = function(friction = 0.9, gravity = 3) {
    ...
    appropriate collision functions. Thes particular values aren't arbitrary. Their binary
    ...
    0010 = 2            0             0             0              1
    1111 = 15        No Walls    Walls on Top  Wall on Right    Four walls
    ...
    which tiles. This approach has not been tested with more advanced shapes. */
...
Game.World.prototype = {
    ...
    collideObject: function(object) { 
        ...
        insance bottom refers to the row in the collision map that the bottom of the 
        object occupies. Right riefers to the column in the collision map occupied by
        the right side of the object. Value refers to the value of a collision tile in
        the map under the specified row and colum occupied by the object. */
        ...
        /* We must redifne top since the last collision check because the object may
...
Game.World.Player = function(x, y) {
    ...
    which collision functions to use based on the value and allows you to tweak the other values to fit the specific tile shape. */
...
Game.World.Collider.prototype = {
    ...
    /* This will resolve collision (if any) between an object and the y location of
    some tile's bottom. All of these functions are pretty much the same, just adjusted
    for differnt sides of a tile and different trajectories of the object. */
    collidePlatformBottom:function(object, tile_bottom) {

        /* If the top of the object is above the bottom of the tile and on the previous
        frame the top object was below the bottom of the tile, we have entered into
        this tile. */
