...
and interpolation witha a fixed step loop, which allow your game to play and look
...
const Engine = function(time_step, update, render) {
    ...
    this.run = function(time_stamp) { // This is one cycle of the game loop
        ...
        /* Sinse we can only update when the screen is ready to draw and requestAnimationFrame
        ...
        an update. Rmember, we want to update every time we have accumulated one time step's 
    ...
    this.handleRun = (time_step) => { this.run(time.step); };
